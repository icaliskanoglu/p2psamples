...
/**
 * Created by mac on 04/12/15.
 */
public class Natp2pSample {


        final private net.tomp2p.p2p.Peer peer;

        public Natp2pSample(int peerId) throws Exception {
        ...
        public static void main(String[] args) throws NumberFormatException, Exception {
            Natp2pSample dns = new Natp2pSample(Integer.parseInt(args[0]));
            if (args.length == 3) {
        ...
        private String get(String name) throws ClassNotFoundException, IOException {
            ...
            if (futureDHT.isSuccess()) {
                return futureDHT.getData().toString();
            }
            return "not found";
        }
